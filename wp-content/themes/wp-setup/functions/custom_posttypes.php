...
function register_custom_post_type_key_visuals() {
    ...
    $labels = array(
        'name'                => __( 'Key Visuals', 'typotron' ),
        'singular_name'       => __( 'Key Visual', 'typotron' ),
        'menu_name'           => __( 'Key Visuals', 'typotron' ),
        'parent_item_colon'   => __( 'Key Visual', 'typotron' ),
        'all_items'           => __( 'Alle Key Visuals', 'typotron' ),
        'view_item'           => __( 'Key Visual ansehen', 'typotron' ),
        'add_new_item'        => __( 'Key Visual hinzufügen', 'typotron' ),
        'add_new'             => __( 'Neues hinzufügen', 'typotron' ),
        'edit_item'           => __( 'Key Visual bearbeiten', 'typotron' ),
        'update_item'         => __( 'Key Visual aktualisieren', 'typotron' ),
        'search_items'        => __( 'Key Visual suchen', 'typotron' ),
        'not_found'           => __( 'Nicht gefunden', 'typotron' ),
        'not_found_in_trash'  => __( 'Nicht im Papierkorb gefunden', 'typotron' ),
    );
    $args = array(
        'label'               => __( 'key_visual', 'typotron' ),
        'description'         => __( 'Key Visual Detail Info', 'typotron' ),
        'labels'              => $labels,
        // 'supports'            => array('editor'),
        'supports'            => array('title'),
        'taxonomies'          => array( 'key_visuals' ),
        'hierarchical'        => false,
        'public'              => true,
        'show_ui'             => true,
        'show_in_menu'        => true,
    ...
    register_post_type( 'key_visual', $args );
